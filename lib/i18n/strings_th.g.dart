...
class TranslationsTh extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override String get update_available_title => 'มีการอัปเดต';
	@override String get favorite_char_hint_security => 'ป้อนตัวละครที่ชื่นชอบเพื่อความปลอดภัย';
	@override String get reauthenticate_with_google => 'โปรดตรวจสอบสิทธิ์กับ Google อีกครั้งเพื่อดำเนินการต่อ';
	@override String get spam_cooldown_warning => 'โปรดรอก่อนที่จะโพสต์อีกครั้ง';
	@override String get update_available_body => 'Amomimus เวอร์ชันใหม่พร้อมใช้งานแล้ว โปรดอัปเดต';
	@override String get user_ghost_warning => 'ผู้ใช้นี้กำลังเป็นผีในขณะนี้';
...
extension on TranslationsTh {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'update_available_title' => 'มีการอัปเดต',
			'favorite_char_hint_security' => 'ป้อนตัวละครที่ชื่นชอบเพื่อความปลอดภัย',
			'reauthenticate_with_google' => 'โปรดตรวจสอบสิทธิ์กับ Google อีกครั้งเพื่อดำเนินการต่อ',
			'spam_cooldown_warning' => 'โปรดรอก่อนที่จะโพสต์อีกครั้ง',
			'update_available_body' => 'Amomimus เวอร์ชันใหม่พร้อมใช้งานแล้ว โปรดอัปเดต',
			'user_ghost_warning' => 'ผู้ใช้นี้กำลังเป็นผีในขณะนี้',
			'passcode' => 'รหัสผ่าน',
